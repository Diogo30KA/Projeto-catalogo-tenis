...
if(isset($_POST["gravar"]))
{
    ...
    $sql = "insert into generos (codigo,nome) 
            values ('$codigo','$nome')";
...
if(isset($_POST["alterar"]))
{
    ...
    $sql = "update generos set nome = '$nome'
            where codigo = '$codigo'";
...
if(isset($_POST["pesquisar"]))
{
    ...
    {
        echo "Resultado da Pesquisa das generos: "."<br>";
        //mostrar na tela os valores encontrados
        while($generos = mysql_fetch_array($resultado))
        {
            echo "Codigo: ".$generos['codigo']."<br>".
                 "Nome: ".$generos['nome']."<br><br>";
        }
    }
}
?>
...
<head>
    ...
    <title>Cadastro generos</title>
</head>
<body>
    <form name="formulario" method="post" action="cadastrogeneros.php">
        <h1>Cadastro dos Gêneros - Empresa
